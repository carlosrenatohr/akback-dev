        ...
        this.getQuestionChoicesTableSettings = function() {
            return {
                ...
                columns: [
                    ...
                    {text: 'Name', dataField: 'Description', width: '26%'},
                    {text: 'Label', dataField: 'Label', width: '26%'},
                    // {text: 'Price', dataField: 'sprice', width: '15%'},
                    {text: 'Price', dataField: 'plPrice', width: '13%'},
                    {text: 'Fixed Price', dataField: 'FixedPrice', width: '12%'},
