    ...
    this.getInventoryGridData = function (empty) {
        ...
        return {
            ...
            columns: [
                ...
                {text: 'Description', dataField: 'Description', type: 'string', width: '12%'},
                {text: 'List', dataField: 'ListPrice', align:'right', cellsalign:'right', width: '9%', filterType:'number'},
                {text: 'Sell', dataField: 'price1', align:'right', cellsalign:'right', width: '9%', filterType:'number'},
                {text: 'Cost', dataField: 'Cost', align:'right', cellsalign:'right',
                    width: '8%', filterType:'number', cellsformat: 'd' + decimalCost,},
