    ...
    this.getInventoryGridData = function (empty, match) {
        ...
        return {
            ...
            columns: [
                ...
                {text: 'Brand', datafield: 'Brand', filtertype: 'checkedlist', width: '12%'},
                ...
                {text: 'QLoc1', dataField: 'QuantityLoc1', type: 'string', width: '2%',
                    align:'right',cellsalign:'right', filterType:'number'},
                {text: 'QLoc2', dataField: 'QuantityLoc2', type: 'string', width: '2%',
                    align:'right',cellsalign:'right', filterType:'number'},
                {text: 'QLoc3', dataField: 'QuantityLoc3', type: 'string', width: '2%',
                    align:'right',cellsalign:'right', filterType:'number'},
