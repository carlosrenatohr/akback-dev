				...
				renderToolbar: function(toolBar)
				{
					...
					$("#table").on('rowselect', function (event) {
						...
						if(row){
							...
							$("#edit_delete_message").text("Are you want to delete Category "+row.Unique+" "+row.MainName+"?");
							$("#edit_delete_icon_message").text("Are you want to delete Category "+row.Unique+" "+row.MainName+"?");
			...
			$("#table_subcat").jqxGrid({
				...
				renderToolbar: function(toolBar)
				{
					...
					$("#table_subcat").on('rowselect', function (event) {
						...
						$("#edit_subcat_delete_message").text("Are you want to delete Category "+row.Unique+" "+row.Name+"?");
						$("#edit_subcat_delete_icon_message").text("Are you want to delete Category "+row.Unique+" "+row.Name+"?");
