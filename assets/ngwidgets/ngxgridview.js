...
*/
(function(b) {
    b.ngx.ngxWidget("ngxGridView", "", {});
    b.extend(b.ngx._ngxGridView.prototype, {
        defineInstance: function() {
            var c = {
                ...
                loadingErrorMessage: "The data is still loading and you cannot set a property or call a method. You can do that once the data binding is completed. ngxGridView raises the 'bindingComplete' event when the binding is completed.",
                localization: null,
                pagerHeight: 28,
                pageSize: 10,
                ...
                scrollBarSize: b.ngx.utilities.scrollBarSize,
                touchscrollBarSize: b.ngx.utilities.touchscrollBarSize,
        ...
        createInstance: function(e) {
            var l = this;
            if (b.ngx.utilities.scrollBarSize != 15) {
                l.scrollBarSize = b.ngx.utilities.scrollBarSize
            }
            if ((l.element.nodeName.toLowerCase() == "table") || b(l.element).children("table").length > 0) {
                ...
                var m = l.host.parent();
                var q = l.host.data();
                q.ngxGridView.host = m;
                q.ngxGridView.element = m[0];
                ...
                var y = new b.ngx.dataAdapter(o);
                l.source = y
            }
            if (l.source && !l.source.dataBind) {
                l.source = new b.ngx.dataAdapter(l.source)
            }
            ...
            l.host.addClass(l.toTP("ngx-grid"));
            l.host.addClass(l.toTP("ngx-reset"));
            l.host.addClass(l.toTP("ngx-rc-all"));
            l.host.addClass(l.toTP("ngx-widget"));
            l.host.addClass(l.toTP("ngx-widget-content"));
            if (l._testmodules()) {
                return
            }
            l.render(true);
            b.ngx.utilities.resize(l.host, function() {
        ...
        getvaluebytype: function(h, d) {
            ...
            if (d.type == "date") {
                if (h == "NaN") {
                    ...
                    if (typeof h == "string") {
                        if (d.format) {
                            var c = b.ngx.dataFormat.parsedate(h, d.format);
                            if (c != null) {
                                g = c
                            }
                        }
                    ...
                    if (g.toString() == "NaN" || g.toString() == "Invalid Date") {
                        if (b.ngx.dataFormat) {
                            h = b.ngx.dataFormat.tryparsedate(h)
                        } else {
                            h = g
                        }
                    } else {
        ...
        _builddataloadelement: function() {
            ...
            this.dataloadelement = b('<div class="ngx-gridView-load" style="z-index: 99998; background-color:rgba(50,50,50,0.1); overflow: hidden; position: absolute;"></div>');
            var d = b('<div style="z-index: 99999; margin-left: -66px; left: 50%; top: 50%; margin-top: -24px; position: relative; width: 100px; height: 33px; padding: 5px; font-family: verdana; font-size: 12px; color: #767676; border-color: #898989; border-width: 1px; border-style: solid; background: #f6f6f6; border-collapse: collapse;"><div style="float: left;"><div style="float: left; overflow: hidden; width: 32px; height: 32px;" class="ngx-grid-load"/><span style="margin-top: 10px; float: left; display: block; margin-left: 5px;" >' + this.gridlocalization.loadtext + "</span></div></div>");
            d.addClass(this.toTP("ngx-rc-all"));
            this.dataloadelement.addClass(this.toTP("ngx-rc-all"));
            d.addClass(this.toTP("ngx-fill-state-normal"));
        ...
        _measureElement: function(d) {
            ...
            c.addClass(this.toTP("ngx-widget"));
        ...
        _testmodules: function() {
            ...
            if (!this.host.ngxScrollBar) {
                c();
                g += " ngxscrollbar.js"
            }
            if (!this.host.ngxButton) {
                c();
                g += " ngxbuttons.js"
            }
            if (!b.ngx.dataAdapter) {
                c();
                g += " ngxdata.js"
            }
            if (g != "" || this.editable || this.filterable || this.pageable) {
                ...
                var f = function(h) {
                    switch (h) {
                        case "checkbox":
                            if (!e.host.ngxCheckBox && !d.checkbox) {
                                d.checkbox = true;
                                c();
                                g += " ngxcheckbox.js"
                            }
                            break;
                        case "dropdownlist":
                            if (!e.host.ngxDropDownList && !d.dropdownlist) {
                                c();
                                d.dropdownlist = true;
                                g += " ngxdropdownlist.js(requires: ngxlistbox.js)"
                            } else {
                                if (!e.host.ngxListBox && !d.listbox) {
                                    c();
                                    d.listbox = true;
                                    g += " ngxlistbox.js"
                                }
                ...
                if (g != "") {
                    throw new Error("ngxGridView: Missing references to the following module(s): " + g);
                    this.host.remove();
                    return true
                }
            }
        ...
        hiddenParent: function() {
            return b.ngx.isHidden(this.host)
        },
        ...
        isTouchDevice: function() {
            ...
            var c = b.ngx.mobile.isTouchDevice();
            this.touchDevice = c;
            if (this.touchmode == true) {
                c = true;
                b.ngx.mobile.setMobileSimulator(this.element);
                this.touchDevice = c
            } else {
            ...
            if (c) {
                ...
                this.host.addClass(this.toThemeProperty("ngx-touch"));
                this.host.find("ngx-widget-content").addClass(this.toThemeProperty("ngx-touch"));
                this.host.find("ngx-widget-header").addClass(this.toThemeProperty("ngx-touch"));
        ...
        localizestrings: function(c, f) {
            ...
            if (b.ngx.dataFormat) {
                b.ngx.dataFormat.cleardatescache()
            }
            if (this._loading) {
                throw new Error("ngxGridView: " + this.loadingErrorMessage);
                return false
            }
            if (c != null) {
                for (var h in c) {
        ...
        _measureElementWidth: function(e) {
            ...
            d.addClass(this.toTP("ngx-widget"));
            d.addClass(this.toTP("ngx-grid"));
            d.addClass(this.toTP("ngx-grid-column-header"));
            d.addClass(this.toTP("ngx-widget-header"));
        ...
        scrollOffset: function(e, d) {
            if (arguments.length == 0 || (e != null && typeof(e) == "object" && !e.top)) {
                return {
                    left: this.hScrollBar.ngxScrollBar("value"),
                    top: this.vScrollBar.ngxScrollBar("value")
                }
            }
            ...
            this.vScrollBar.ngxScrollBar("setPosition", e);
            this.hScrollBar.ngxScrollBar("setPosition", d)
        },
        scrollleft: function(c) {
            ...
            if (this.hScrollBar.css("visibility") != "hidden") {
                this.hScrollBar.ngxScrollBar("setPosition", c)
            }
        },
        scrolltop: function(c) {
            ...
            if (this.vScrollBar.css("visibility") != "hidden") {
                this.vScrollBar.ngxScrollBar("setPosition", c)
            }
        },
        ...
        databind: function(g, i, c) {
            ...
            this.dataview = this.dataview || new b.ngx.dataView();
            ...
            this.dataview.update = function(z) {
                ...
                if (f.groups && f.groups.length > 0) {
                    ...
                    f.source.records.sort(function(B, j) {
                        ...
                        B = B.toString();
                        j = j.toString();
                        if (b.ngx.dataFormat.isNumber(B) && b.ngx.dataFormat.isNumber(j)) {
                            if (B < j) {
                                return -1
                            }
                            if (B > j) {
                            ...
                            if (b.ngx.dataFormat.isDate(B) && b.ngx.dataFormat.isDate(j)) {
                                if (B < j) {
                                    return -1
                                }
                                if (B > j) {
                        ...
                        if (m) {
                            for (var o = 0; o < m.length; o++) {
                                ...
                                if (!m[o].type) {
                                    ...
                                    if (b.ngx.dataFormat.isNumber(y) || (!isNaN(parseFloat(y)) && isFinite(y))) {
                                        m[o].type = "number"
                                    }
                                    if (b.ngx.dataFormat.isDate(y)) {
                                        m[o].type = "date"
                                    }
                                }
                            }
                ...
                if (f.pageable) {
                    if (!f.disabled) {
                        if (f.pagernexttop) {
                            f.pagerfirsttop.ngxButton({
                                disabled: false
                            });
                            f.pagerfirstbottom.ngxButton({
                                disabled: false
                            });
                            f.pagerlasttop.ngxButton({
                                disabled: false
                            });
                            f.pagerlastbottom.ngxButton({
                                disabled: false
                            });
                            f.pagernexttop.ngxButton({
                                disabled: false
                            });
                            f.pagerprevioustop.ngxButton({
                                disabled: false
                            });
                            if (f.pagershowrowscombotop.ngxDropDownList) {
                                if (f.pagerMode == "advanced") {
                                    f.pagershowrowscombotop.ngxDropDownList({
                                        disabled: false
                                    });
                                    f.pagershowrowscombobottom.ngxDropDownList({
                                        disabled: false
                                    })
                                }
                            }
                            f.pagernextbottom.ngxButton({
                                disabled: false
                            });
                            f.pagerpreviousbottom.ngxButton({
                                disabled: false
                            })
                        }
                    }
                ...
                if (!f.initializedcall) {
                    ...
                    if (f.host.css("visibility") == "hidden") {
                        var n = b.ngx.browser.msie && b.ngx.browser.version < 8;
        ...
        ensureColumnVisible: function(d) {
            ...
            if (this.hScrollBar.css("visibility") != "hidden") {
                var h = this.hScrollBar.ngxScrollBar("value");
                var e = h + this.host.width();
                if (h > g - c) {
                    this.hScrollBar.ngxScrollBar("setPosition", g - c)
                } else {
                    if (g > e) {
                        this.hScrollBar.ngxScrollBar("setPosition", h + g - e)
                    }
                }
            }
        },
        ensurerowvisiblebykey: function(o) {
            ...
            var m = this.vScrollBar.ngxScrollBar("value");
            ...
            if (Math.round(p.position().top) === 0) {
                return this.vScrollBar.ngxScrollBar("setPosition", 0)
            } else {
                ...
                if (k) {
                    if (k[0] === p[0]) {
                        ...
                        return this.vScrollBar.ngxScrollBar("setPosition", this.vScrollBar.ngxScrollBar("max"))
                    }
                }
            }
            if (i < f) {
                ...
                return this.vScrollBar.ngxScrollBar("setPosition", h)
            }
            if (l > c) {
                return this.vScrollBar.ngxScrollBar("setPosition", 4 + l - e)
            }
        },
        ...
        _updateTouchScrolling: function() {
            var d = this.that;
            if (d.isTouchDevice()) {
                var f = b.ngx.mobile.getTouchEventName("touchstart");
                var e = b.ngx.mobile.getTouchEventName("touchend");
                var c = b.ngx.mobile.getTouchEventName("touchmove");
                if (d.gridcontent) {
                    ...
                    b.ngx.mobile.touchScroll(d.gridcontent[0], Math.max(d.vScrollInstance.max, d.hScrollInstance.max), function(i, h) {
        ...
        _showicons: function() {
            ...
            for (var e = 0; e < this.columns.records.length; e++) {
                ...
                if ((g.align != "left" && g.align != "center" && !this.rtl) || (this.rtl && g.align != "right" && g.align != "center")) {
                    var h = b.ngx.isHidden(b(g.filtericon)) ? 0 : 16;
                    h += b.ngx.isHidden(b(g.sortasc)) ? 0 : 16;
                    h += b.ngx.isHidden(b(g.sortdesc)) ? 0 : 16;
        ...
        render: function(j) {
            ...
            this.content.addClass(this.toTP("ngx-reset"));
            var h = this.host.find("#verticalScrollBar" + this.element.id);
            var l = this.host.find("#horizontalScrollBar" + this.element.id);
            this.bottomRight = this.host.find("#bottomRight").addClass(this.toTP("ngx-grid-bottomright")).addClass(this.toTP("ngx-scrollbar-state-normal"));
            if (this.vScrollBar) {
                this.vScrollBar.ngxScrollBar("destroy")
            }
            if (this.hScrollBar) {
                this.hScrollBar.ngxScrollBar("destroy")
            }
            this.vScrollBar = h.ngxScrollBar({
                vertical: true,
                rtl: this.rtl,
            ...
            this.hScrollBar = l.ngxScrollBar({
                vertical: false,
                rtl: this.rtl,
                touchMode: this.touchmode,
                theme: this.theme,
            ...
            this.vScrollInstance = b.data(this.vScrollBar[0], "ngxScrollBar").instance;
            this.hScrollInstance = b.data(this.hScrollBar[0], "ngxScrollBar").instance;
            this.filter = this.host.find("#filter");
            this.filter[0].id = "filter" + this.element.id;
            this.filter.addClass(this.toTP("ngx-widget-header"));
            this.filter.addClass(this.toTP("ngx-grid-toolbar"));
            ...
            this.toolbar.addClass(this.toTP("ngx-grid-toolbar"));
            this.toolbar.addClass(this.toTP("ngx-widget-header"));
            this.aggregates = this.host.find("#aggregates");
            this.aggregates[0].id = "aggregates" + this.element.id;
            this.aggregates.addClass(this.toTP("ngx-grid-statusbar"));
            this.aggregates.addClass(this.toTP("ngx-widget-header"));
            this.statusbar = this.host.find("#statusbar");
            this.statusbar[0].id = "statusbar" + this.element.id;
            this.statusbar.addClass(this.toTP("ngx-grid-statusbar"));
            this.statusbar.addClass(this.toTP("ngx-widget-header"));
            this.pager.addClass(this.toTP("ngx-grid-pager"));
            this.pager.addClass(this.toTP("ngx-widget-header"));
            this.toppager = this.host.find("#toppager");
            this.toppager.addClass(this.toTP("ngx-grid-pager-top"));
            this.toppager.addClass(this.toTP("ngx-widget-header"));
            this.gridtable = null;
        ...
        _render: function() {
            ...
            if (this.columns == null) {
                this.columns = new b.ngx.dataCollection(this.element)
            } else {
                this._initializeColumns()
            }
            this.host.height(this.height);
            this.host.width(this.width);
            b.ngx.utilities.html(this.content, "");
            this.columnsheader = this.columnsheader || b('<div style="overflow: hidden;"></div>');
            this.columnsheader.remove();
            this.columnsheader.addClass(this.toTP("ngx-widget-header"));
            this.columnsheader.addClass(this.toTP("ngx-grid-header"));
            if (!this.showHeader) {
            ...
            this.gridcontent.addClass(this.toTP("ngx-grid-content"));
            this.gridcontent.addClass(this.toTP("ngx-widget-content"));
            ...
            if (this.disabled) {
                this.host.addClass(this.toThemeProperty("ngx-fill-state-disabled"))
            }
            this._renderhorizontalscroll();
            this._showicons();
            this._addHandlers()
        ...
        _initpager: function() {
            ...
            if (!this.pagerRenderer) {
                ...
                var f = function(s, E) {
                    ...
                    if (b.ngx.browser.msie && b.ngx.browser.version < 8) {
                    ...
                    if (n.pagerMode == "default") {
                        ...
                        v.addClass(n.toThemeProperty("ngx-icon-arrow-first"));
                        m.wrapInner(v);
                        var o = b("<div style='margin-left: 6px; width: 15px; height: 15px;'></div>");
                        o.addClass(n.toThemeProperty("ngx-icon-arrow-last"));
                        q.wrapInner(o);
                        if (!n.rtl) {
                            s.append(m);
                            s.append(j);
                    ...
                    k.addClass(n.toThemeProperty("ngx-icon-arrow-left"));
                    j.wrapInner(k);
                    var l = b("<div style='margin-left: 6px; width: 15px; height: 15px;'></div>");
                    l.addClass(n.toThemeProperty("ngx-icon-arrow-right"));
                    t.wrapInner(l);
                    if (!n.rtl) {
                        s.append(z)
                    }
                    if (n.pagerMode != "default") {
                        ...
                        var w = r.find("input");
                        w.addClass(n.toThemeProperty("ngx-input"));
                        w.addClass(n.toThemeProperty("ngx-widget-content"));
                        if (this.rtl) {
                            w.css("direction", "rtl")
                        }
                        var n = this;
                        ...
                        this.addHandler(A, "select", function(K) {
                            if (K.args) {
                                ...
                                var I = K.args.index;
                                n.pagershowrowscombotop.data().ngxDropDownList.instance.selectIndex(I);
                                n.pagershowrowscombobottom.data().ngxDropDownList.instance.selectIndex(I);
                                n.pagershowrowscombobottom.data().ngxDropDownList.instance.renderSelection("mouse");
                                n.pagershowrowscombotop.data().ngxDropDownList.instance.renderSelection("mouse");
                                ...
                                if (H >= 100) {
                                    n.pagershowrowscombotop.ngxDropDownList({
                                        width: 55
                                    });
                                    n.pagershowrowscombobottom.ngxDropDownList({
                                        width: 55
                                    })
                                } else {
                                    n.pagershowrowscombotop.ngxDropDownList({
                        ...
                        var r = r.find("input");
                        r.addClass(n.toThemeProperty("ngx-grid-pager-input"));
                        r.addClass(n.toThemeProperty("ngx-rc-all"));
                    ...
                    n.addHandler(t, "mouseenter", function() {
                        l.addClass(n.toThemeProperty("ngx-icon-arrow-right-hover"))
                    });
                    n.addHandler(j, "mouseenter", function() {
                        k.addClass(n.toThemeProperty("ngx-icon-arrow-left-hover"))
                    });
                    n.addHandler(t, "mouseleave", function() {
                        l.removeClass(n.toThemeProperty("ngx-icon-arrow-right-hover"))
                    });
                    n.addHandler(j, "mouseleave", function() {
                        k.removeClass(n.toThemeProperty("ngx-icon-arrow-left-hover"))
                    });
                    n.addHandler(t, "mousedown", function() {
                        l.addClass(n.toThemeProperty("ngx-icon-arrow-right-selected"))
                    });
                    n.addHandler(t, "mouseup", function() {
                        l.removeClass(n.toThemeProperty("ngx-icon-arrow-right-selected"))
                    });
                    n.addHandler(j, "mousedown", function() {
                        k.addClass(n.toThemeProperty("ngx-icon-arrow-left-selected"))
                    });
                    n.addHandler(j, "mouseup", function() {
                        k.removeClass(n.toThemeProperty("ngx-icon-arrow-left-selected"))
                    });
                    if (n.pagerMode === "default") {
                        n.addHandler(q, "mouseenter", function() {
                            o.addClass(n.toThemeProperty("ngx-icon-arrow-last-hover"))
                        });
                        n.addHandler(m, "mouseenter", function() {
                            v.addClass(n.toThemeProperty("ngx-icon-arrow-first-hover"))
                        });
                        n.addHandler(q, "mouseleave", function() {
                            o.removeClass(n.toThemeProperty("ngx-icon-arrow-last-hover"))
                        });
                        n.addHandler(m, "mouseleave", function() {
                            v.removeClass(n.toThemeProperty("ngx-icon-arrow-first-hover"))
                        });
                        n.addHandler(q, "mousedown", function() {
                            o.addClass(n.toThemeProperty("ngx-icon-arrow-last-selected"))
                        });
                        n.addHandler(m, "mousedown", function() {
                            v.addClass(n.toThemeProperty("ngx-icon-arrow-first-selected"))
                        });
                        n.addHandler(q, "mouseup", function() {
                            o.removeClass(n.toThemeProperty("ngx-icon-arrow-last-selected"))
                        });
                        n.addHandler(m, "mouseup", function() {
                            v.removeClass(n.toThemeProperty("ngx-icon-arrow-first-selected"))
                        })
                    }
        ...
        updatepagerdetails: function() {
                    ...
                    var r = function(y, w) {
                        for (var x = 0; x < w.length; x++) {
                            ...
                            if (w[x].records && (w[x][m.expanded] || w[x][m.leaf])) {
                                if (w[x]._visible !== false) {
                                    r(y + 1, w[x].records);
                                    if (this.treeGrid && b(this.treeGrid).ngxTreeGrid("showSubAggregates")) {
                                        if (y != 0) {
                                            g--
                                        }
                                    }
            ...
            if (this.pagerMode != "default") {
                ...
                while ((this.rtl && s >= 0) || (!this.rtl && s < n)) {
                    ...
                    var f = Math.floor(p);
                    e += f * n;
                    var c = this.toTP("ngx-grid-pager-number");
                    c += " " + this.toTP("ngx-rc-all");
                    if (e > t && !this.rtl) {
                        break
                    } else {
                        if (this.rtl && e > t) {
                    ...
                    if (this.dataview.pagenum === e - 1) {
                        c += " " + this.toTP("ngx-fill-state-pressed")
                    }
                    if (!this.rtl) {
                ...
                if (this.disabled) {
                    this.host.find(".ngx-grid-pager-number").css("cursor", "default")
                }
                var q = function() {
                    h.click(function(i) {
                        if (j.disabled) {
                    ...
                    h.mouseenter(function(i) {
                        ...
                        b(i.target).addClass(j.toTP("ngx-fill-state-hover"))
                    });
                    h.mouseleave(function(i) {
                        if (j.disabled) {
                            return
                        }
                        b(i.target).removeClass(j.toTP("ngx-fill-state-hover"))
                    })
                };
            ...
            if (this.columnGroups) {
                ...
                if (this.columnGroups.length) {
                    ...
                    for (var g = 0; g < this.columnGroups.length; g++) {
                        ...
                        if (s != 0) {
                            throw new Error("ngxGridView: Column Groups initialization Error. Please, check the initialization of the ngxGridView's columns array. The columns in a column group cannot be pinned.")
                        }
                        h.sort(function(j, i) {
                            j = parseInt(j);
                            i = parseInt(i);
                        ...
                        for (var k = 1; k < h.length; k++) {
                            if (h[k] != h[k - 1] + 1) {
                                throw new Error("ngxGridView: Column Groups initialization Error. Please, check the initialization of the ngxGridView's columns array. The columns in a column group are expected to be siblings in the columns array.");
                                this.host.remove()
                            }
                        }
                    }
        ...
        _removeHandlers: function() {
            ...
            this.removeHandler(b(window), "ngxReady." + this.element.id);
            if (this._mousewheelfunc) {
                this.removeHandler(this.host, "mousewheel", this._mousewheelfunc)
            }
            var c = "mousedown";
            if (this.isTouchDevice()) {
                c = b.ngx.mobile.getTouchEventName("touchstart")
            }
            ...
            if (this.table) {
                ...
                if (b.ngx.browser.msie && b.ngx.browser.version < 9) {
        ...
        _addHandlers: function() {
            ...
            this.addHandler(b(window), "ngxReady." + this.element.id, function() {
                            ...
                            if (!e.vScrollInstance.isScrolling() && !e.vScrollInstance.isScrolling()) {
                                ...
                                if (t) {
                                    var l = function(x) {
                                        ...
                                        if (w.ngxWidget && w.ngxWidget.container && w.ngxWidget.container[0].style.display == "block") {
                                            var i = w.ngxWidget;
            ...
            var d = "mousedown";
            if (this.isTouchDevice()) {
                d = b.ngx.mobile.getTouchEventName("touchend");
                if (b.ngx.browser.msie && b.ngx.browser.version < 10) {
                    d = "mousedown"
                }
            }
            var g = function(r, q) {
                ...
                if (e.hoveredRow) {
                    ...
                    var h = function(l) {
                        for (var m = 0; m < l.length; m++) {
                            var k = l[m];
                            var n = k.className;
                            n = n.replace(" " + e.toTP("ngx-fill-state-hover"), "");
                            n = n.replace(" " + e.toTP("ngx-grid-cell-hover"), "");
                            k.className = n
                        }
                    };
                    h(i);
            ...
            var f = function(n) {
                ...
                for (var l = p; l < k.length - j; l++) {
                    var h = k[l];
                    h.className += " " + e.toTP("ngx-fill-state-hover") + " " + e.toTP("ngx-grid-cell-hover")
                }
                if (e._pinnedTable) {
            ...
            this.addHandler(this.table, d, function(A) {
                ...
                if (e.isTouchDevice()) {
                    var D = b.ngx.position(A);
                    r = D.left;
                    q = D.top;
                    if (isNaN(r) || isNaN(q)) {
                        var D = b.ngx.position(A.originalEvent);
                        r = D.left;
                        q = D.top
                    }
                }
                ...
                if (E !== undefined) {
                    ...
                    e.clickTime = new Date();
                    if (p.className.indexOf("ngx-grid-group") >= 0) {
                        if (!k.expanded) {
                        ...
                        if (A.target && A.target.className.indexOf("ngx-grid-group") >= 0 && e.treeGrid) {
                            if (!k.expanded) {
                ...
                if (l.rowinfo[p] && l.selectionMode !== "none") {
                    if (l.rowinfo[p].selected) {
                        for (var g = d; g < q.length - f; g++) {
                            var o = q[g];
                            b(o).addClass(l.toTP("ngx-grid-cell-selected") + " " + l.toTP("ngx-fill-state-pressed"));
                            if (c) {
                                b(c[g]).addClass(l.toTP("ngx-grid-cell-selected") + " " + l.toTP("ngx-fill-state-pressed"))
                            }
                        }
                    } else {
                        for (var g = d; g < q.length - f; g++) {
                            ...
                            var m = o.className;
                            m = m.replace(" ngx-fill-state-pressed", "");
                            m = m.replace(" ngx-fill-state-pressed-" + l.theme, "");
                            m = m.replace(" ngx-grid-cell-selected", "");
                            m = m.replace(" ngx-grid-cell-selected-" + l.theme, "");
                            o.className = m;
                            if (k) {
                                k.className = m
                            }
        ...
        _getMatches: function(f, g) {
            ...
            b.each(c, function(k) {
                ...
                var j = b.ngx.string.startsWithIgnoreCase(l.toString(), f);
                if (j) {
                    h.push(this.uid)
                }
            });
        ...
        exportData: function(t) {
            if (!b.ngx.dataAdapter.ArrayExporter) {
                if (!this.treeGrid) {
                    throw "ngxGridView: Missing reference to ngxdata.export.js!"
                }
                throw "ngxTreeGrid: Missing reference to ngxdata.export.js!"
            }
            ...
            if (F === undefined) {
                F = this.treeGrid ? "ngxTreeGrid_Data" : "ngxGridView_Data"
            }
            var s = this;
            var Y = this.getRows();
            ...
            var C = {};
            var l = [];
            var M = this.host.find(".ngx-grid-cell:first");
            var n = this.host.find(".ngx-grid-cell-alt:first");
            var ad = this.toThemeProperty;
            M.removeClass(ad("ngx-grid-cell-selected"));
            M.removeClass(ad("ngx-fill-state-pressed"));
            n.removeClass(ad("ngx-grid-cell-selected"));
            n.removeClass(ad("ngx-fill-state-pressed"));
            M.removeClass(ad("ngx-grid-cell-hover"));
            M.removeClass(ad("ngx-fill-state-hover"));
            n.removeClass(ad("ngx-grid-cell-hover"));
            n.removeClass(ad("ngx-fill-state-hover"));
            var E = "cell";
            var B = 1;
            var K = "column";
            var z = 1;
            ...
            b.each(p, function(ag) {
                ...
                var ah = function(am) {
                    ...
                    am.removeClass(ao("ngx-cell"));
                    am.removeClass(ao("ngx-grid-cell-selected"));
                    am.removeClass(ao("ngx-fill-state-pressed"));
                    am.removeClass(ao("ngx-grid-cell-hover"));
                    am.removeClass(ao("ngx-fill-state-hover"));
            ...
            var J = this;
            var T = b.ngx.dataAdapter.ArrayExporter(Y, Z, C, P, this.treeGrid && (t == "xml" || t == "json"));
            if (F == undefined) {
                this._renderrows();
                var v = T.exportTo(t);
                if (this.showAggregates) {
            ...
            if (g != null) {
                ...
                if (c != null) {
                    ...
                    if (typeof c == "boolean") {
                        ...
                        if (b.ngx.dataFormat.isNumber(c)) {
                            f = "number"
                        } else {
                            var i = new Date(c);
                            if (i.toString() == "NaN" || i.toString() == "Invalid Date") {
                                if (b.ngx.dataFormat) {
                                    i = b.ngx.dataFormat.tryparsedate(c);
                                    if (i != null) {
                                        if (i && i.getFullYear()) {
        ...
        setCellValueByKey: function(C, r, v) {
            ...
            if (h != null && h[r] !== v) {
                ...
                if (!e.nullable || (v != null && v !== "" && e.nullable && v.label === undefined)) {
                    if (b.ngx.dataFormat.isNumber(n) || f == "number" || f == "float" || f == "int" || f == "decimal" && f != "date") {
                        v = new Number(v);
                        v = parseFloat(v);
                        if (isNaN(v)) {
                            v = 0
                        ...
                        if (b.ngx.dataFormat.isDate(n) || f == "date") {
                            if (v != "") {
                                var y = v;
                                y = new Date(y);
        ...
        getCellTextByKey: function(e, d) {
            ...
            if (f && f.cellsFormat != "") {
                if (b.ngx.dataFormat) {
                    if (b.ngx.dataFormat.isDate(c)) {
                        c = b.ngx.dataFormat.formatdate(c, f.cellsFormat, this.gridlocalization)
                    } else {
                        if (b.ngx.dataFormat.isNumber(c) || (!isNaN(parseFloat(c)) && isFinite(c))) {
                            c = b.ngx.dataFormat.formatnumber(c, f.cellsFormat, this.gridlocalization)
                        }
                    }
                }
            }
        ...
        beginroweditbykey: function(E, q) {
            ...
            if (B) {
                ...
                for (var y = 0; y < h.length; y++) {
                    ...
                    b(d).removeClass(this.toTP("ngx-grid-cell-selected"));
                    b(d).removeClass(this.toTP("ngx-fill-state-pressed"));
                    b(d).removeClass(this.toTP("ngx-grid-cell-hover"));
                    b(d).removeClass(this.toTP("ngx-fill-state-hover"));
                    ...
                    switch (g.columntype) {
                        ...
                        case "default":
                            ...
                            j.addClass(this.toThemeProperty("ngx-input"));
                            j.addClass(this.toThemeProperty("ngx-widget-content"));
                            j.addClass(this.toThemeProperty("ngx-cell-editor"));
                            ...
                            if (!g.editable) {
                                ...
                                j.addClass(this.toThemeProperty("ngx-fill-state-disabled"))
                            } else {
                                if (!p) {
                                    p = true;
                                    var f = b.ngx.browser.msie && b.ngx.browser.version > 10;
                                    if (!f) {
                                        j.focus()
                                    }
                                    var c = j;
                            ...
                            if (h.cellsFormat != "") {
                                ...
                                if (f || (l === "string" && (h.cellsFormat.indexOf("H") != -1 || h.cellsFormat.indexOf("m") != -1 || h.cellsFormat.indexOf("M") != -1 || h.cellsFormat.indexOf("y") != -1 || h.cellsFormat.indexOf("h") != -1 || h.cellsFormat.indexOf("d") != -1))) {
                                    ...
                                    if (m == "Invalid Date" || m == null || h.cellsFormat.length > 1) {
                                        if (b.ngx.dataFormat) {
                                            m = b.ngx.dataFormat.parsedate(e, h.cellsFormat, this.gridlocalization)
                                        }
        ...
        _validateEditors: function(c) {
            ...
            for (var h = 0; h < m.length; h++) {
                ...
                if (f.validation) {
                    j.removeClass(k.toThemeProperty("ngx-grid-validation-label"));
                    var e = f.datafield;
                    try {
                        var r = f.validation({
                            value: o,
                            ...
                            for (var w = 0; w < m.length; w++) {
                                ...
                                if (k.editorsCache) {
                                    ...
                                    if (k.editorsCache[y]) {
                                        ...
                                        if (!v.ngxWidget && b(z).children()[0] && b(b(z).children()[0]).data().ngxWidget) {
        ...
        _showvalidationpopup: function(q, e, r, m) {
            ...
            m.addClass(this.toThemeProperty("ngx-grid-validation-label"));
            ...
            p.html(r);
            o.addClass(this.toThemeProperty("ngx-grid-validation-arrow-up"));
            p.addClass(this.toThemeProperty("ngx-grid-validation"));
            p.addClass(this.toThemeProperty("ngx-rc-all"));
            p.hide();
            o.hide();
            ...
            if (c >= this._table.height()) {
                o.removeClass(this.toThemeProperty("ngx-grid-validation-arrow-up"));
                o.addClass(this.toThemeProperty("ngx-grid-validation-arrow-down"));
                c = parseInt(k.position().top) - k.outerHeight() - 5;
                if (c < 0) {
                    c = 0;
                    o.removeClass(this.toThemeProperty("ngx-grid-validation-arrow-down"));
                    f = true
                }
                p.css("top", c + "px");
            ...
            m.mouseenter(function() {
                if (m.hasClass("ngx-grid-validation-label")) {
                    p.show();
                    o.show()
                }
            });
        ...
        addRow: function(d, p, j, n) {
            if (p != undefined) {
                ...
                var g = function(r, q, u, e) {
                    if (r._loading) {
                        throw new Error("ngxGridView: " + r.loadingErrorMessage);
                        return false
                    }
        ...
        deleterowbykey: function(g) {
            if (g != undefined) {
                ...
                var d = function(m, l) {
                    if (m._loading) {
                        throw new Error("ngxGridView: " + m.loadingErrorMessage);
                        return false
                    }
                    var o = false;
        ...
        updaterowbykey: function(c, k, g, i) {
            if (c != undefined && k != undefined) {
                ...
                var d = function(o, l, t) {
                    if (o._loading) {
                        throw new Error("ngxGridView: " + o.loadingErrorMessage);
                        return false
                    }
                    var r = false;
                    if (!b.isArray(l)) {
        ...
        showdetailsbykey: function(k) {
            ...
            if (l) {
                ...
                if (f) {
                    ...
                    if (!this.rtl) {
                        h.removeClass(this.toThemeProperty("ngx-grid-group-collapse"));
                        h.addClass(this.toThemeProperty("ngx-grid-group-expand"));
                        h.removeClass(this.toThemeProperty("ngx-icon-arrow-right"));
                        h.addClass(this.toThemeProperty("ngx-icon-arrow-down"))
                    } else {
                        h.removeClass(this.toThemeProperty("ngx-grid-group-collapse-rtl"));
                        h.addClass(this.toThemeProperty("ngx-grid-group-expand-rtl"));
                        h.removeClass(this.toThemeProperty("ngx-icon-arrow-left"));
                        h.addClass(this.toThemeProperty("ngx-icon-arrow-down"))
                    }
                    f.next().show();
                    var d = i.next();
        ...
        hidedetailsbykey: function(h) {
            ...
            if (j) {
                ...
                if (d) {
                    ...
                    if (!this.rtl) {
                        i.addClass(this.toThemeProperty("ngx-grid-group-collapse"));
                        i.removeClass(this.toThemeProperty("ngx-grid-group-expand"));
                        i.addClass(this.toThemeProperty("ngx-icon-arrow-right"));
                        i.removeClass(this.toThemeProperty("ngx-icon-arrow-down"))
                    } else {
                        i.addClass(this.toThemeProperty("ngx-grid-group-collapse-rtl"));
                        i.removeClass(this.toThemeProperty("ngx-grid-group-expand-rtl"));
                        i.addClass(this.toThemeProperty("ngx-icon-arrow-left"));
                        i.removeClass(this.toThemeProperty("ngx-icon-arrow-down"))
                    }
                    d.next().hide();
                    e.next().hide();
        ...
        _initializeColumns: function() {
            ...
            var j = this;
            var c = new b.ngx.dataCollection(this.element);
            var h = 0;
            ...
            b.each(this.columns, function(i) {
                if (j.columns[i] != undefined) {
                    ...
                    if (this.datafield == null) {
                        ...
                        if (g[this.datafield]) {
                            throw new Error("ngxGridView: Invalid column 'dataField' setting. ngxGridView's columns should be initialized with unique data fields.");
                            j.host.remove();
                            return false
                        } else {
            ...
            if (arguments && arguments.length > 0) {
                if (this._updateSimpleFilter) {
                    if (this.filtercolumnsList) {
                        var d = this.filtercolumnsList.ngxDropDownList("getSelectedItem").value;
        ...
        _renderfilter: function() {
            var h = this;
            var j = b("<div style='position: relative; margin: 4px;'><input style='height: 22px; direction: ltr;' role='textbox' type='text' ng-model='akvalue'/><div style='cursor: pointer; height: 100%;'><div></div></div></div>");
            j.height(22);
            var o = j.find("input");
            var g = j.find("div:first");
            j.addClass(this.toThemeProperty("ngx-rc-all"));
            j.addClass(this.toThemeProperty("ngx-widget"));
            j.addClass(this.toThemeProperty("ngx-input-group"));
            o.addClass(this.toThemeProperty("ngx-input"));
            o.addClass(this.toThemeProperty("focusme"));
            o.addClass(this.toThemeProperty("ngx-rc-l"));
            o.addClass(this.toThemeProperty("ngx-input-group-addon"));
            o.addClass(this.toThemeProperty("autoclicksearch"));
            o.addClass(this.toThemeProperty("ngx-widget"));
            o.addClass(this.toThemeProperty("ngx-widget-content"));
            g.addClass(this.toThemeProperty("ngx-fill-state-normal"));
            g.addClass(this.toThemeProperty("ngx-rc-r"));
            g.addClass(this.toThemeProperty("ngx-input-group-addon"));
            g.find("div").addClass(this.toThemeProperty("ngx-icon-search"));
            if (this.rtl) {
                o.addClass(this.toThemeProperty("ngx-rtl"));
                o.css("direction", "rtl")
            }
            ...
            var m = function() {
                if (!g.hasClass("ngx-fill-state-disabled")) {
                    var r = o.val();
                    if (c.ngxDropDownList) {
                        var u = c.ngxDropDownList("getSelectedItem")
                    }
                    var w = function(B, x, i) {
                        var A = new b.ngx.filter();
            ...
            if (this.filterMode == "advanced") {
                ...
                this.addHandler(e, "click", function(q) {
                    ...
                    var r = function() {
                        h.filtercolumnsList.ngxDropDownList({
                            disabled: true
                        });
                        h.filterinput.addClass(h.toThemeProperty("ngx-fill-state-disabled"));
                        h.filterinput.attr("disabled", true);
                        h.filterbutton.addClass(h.toThemeProperty("ngx-fill-state-disabled"))
                    };
                    if (h.filter.find(".filterrow").length === 0) {
                        ...
                        if (h.filter.find(".filterrow").css("display") === "none") {
                            ...
                            h.filterinput.removeClass(h.toThemeProperty("ngx-fill-state-disabled"));
                            h.filterinput.attr("disabled", false);
                            h.filterbutton.removeClass(h.toThemeProperty("ngx-fill-state-disabled"));
                            n(h.filtercolumnsList.ngxDropDownList("getSelectedItem").value);
            ...
            k.addClass(h.toThemeProperty("ngx-icon-close"));
            j.append(k);
            k.hide();
            h.filtericon = k;
            k.click(function() {
        ...
        _renderadvancedfilter: function() {
            ...
            var c = function() {
                h.clearFilters(false, false);
                var n = h.filtercolumnsList.ngxDropDownList("getSelectedItem").value;
                ...
                for (var m = 0; m < h.filterrow[0].cells.length; m++) {
                    ...
                    if (q.length == 0) {
                        ...
                        var w = q.ngxDropDownList("getSelectedItem");
                        if (w) {
            ...
            var e = function() {
                ...
                var k = 0;
                var j = h.filtercolumnsList.ngxDropDownList("getSelectedItem").value;
                ...
                b.each(h.columns.records, function() {
                    ...
                    if (p.pinned) {
                        ...
                        n.addClass(h.toThemeProperty("ngx-widget-header"))
                    }
                    m[0].cells.push(n[0]);
                    if (!this.filterable) {
                        return true
                    ...
                    o.addClass(h.toThemeProperty("ngx-input"));
                    o.addClass(h.toThemeProperty("ngx-rc-all"));
                    o.addClass(h.toThemeProperty("ngx-widget"));
                    o.addClass(h.toThemeProperty("ngx-widget-content"));
                    ...
                    q.append(b("<div style='width: 16px; height: 16px;' class='" + h.toThemeProperty("ngx-grid-column-filterbutton") + "'></div>"));
                    o.focus(function() {
                    ...
                    q.click(function() {
                        ...
                        t.ngxDropDownList({
                            ...
                            selectionRenderer: function() {
                                return "<div style='width: 16px; height: 16px;' class='" + h.toThemeProperty("ngx-grid-column-filterbutton") + "'></div>"
                            }
                        });
        ...
        _renderrows: function() {
            ...
            var G = this.toTP("ngx-cell") + " " + this.toTP("ngx-widget-content");
            if (this.rtl) {
                G += " " + this.toTP("ngx-cell-rtl")
            }
            var J = this.columns.records.length;
            var am = b.ngx.browser.msie && b.ngx.browser.version < 8;
            if (am) {
            ...
            var aj = this.rtl ? " " + this.toTP("ngx-grid-table-rtl") : "";
            var A = "<table cellspacing='0' cellpadding='0' class='" + this.toTP("ngx-grid-table") + aj + "' id='table" + this.element.id + "'><colgroup>";
            var ao = "<table cellspacing='0' cellpadding='0' class='" + this.toTP("ngx-grid-table") + aj + "' id='pinnedtable" + this.element.id + "'><colgroup>";
            var H = 0;
            var s = J;
            for (var ak = 0; ak < J; ak++) {
                var Y = this.columns.records[ak];
            ...
            if (T === 0) {
                ...
                var G = this.toTP("ngx-cell") + " " + this.toTP("ngx-grid-cell") + " " + this.toTP("ngx-item");
                G += " " + this.toTP("ngx-center-align");
                l += '" class="' + G + '">';
            ...
            for (var al = 0; al < ah.length; al++) {
                ...
                for (var ak = 0; ak < J; ak++) {
                    ...
                    var G = this.toTP("ngx-cell") + " " + this.toTP("ngx-grid-cell") + " " + this.toTP("ngx-item");
                    if (ad.pinned) {
                        G += " " + this.toTP("ngx-grid-cell-pinned")
                    }
                    if (this.sortcolumn === ad.displayfield) {
                        G += " " + this.toTP("ngx-grid-cell-sort")
                    }
                    if (this.altRows && al % 2 != 0) {
                        G += " " + this.toTP("ngx-grid-cell-alt")
                    }
                    if (this.rtl) {
                        G += " " + this.toTP("ngx-cell-rtl")
                    }
                    ...
                    if (this.rowinfo[F.uid]) {
                        if (this.rowinfo[F.uid].selected && !ad.rowDetailscolumn) {
                            if (this.editKey !== F.uid) {
                                if (this.selectionMode !== "none") {
                                    G += " " + this.toTP("ngx-grid-cell-selected");
                                    G += " " + this.toTP("ngx-fill-state-pressed")
                                }
                            }
                        }
                        if (this.rowinfo[F.uid].locked) {
                            G += " " + this.toTP("ngx-grid-cell-locked")
                        }
                    }
                    if (!(ad.hidden)) {
                        p += an + e;
                        ...
                        if (this.rowinfo[F.uid]) {
                            if (!this.rowinfo[F.uid].nodetails) {
                                if (this.rowinfo[F.uid].expanded) {
                                    if (!this.rtl) {
                                        G += " " + this.toTP("ngx-grid-group-expand")
                                    } else {
                                        G += " " + this.toTP("ngx-grid-group-expand-rtl")
                                    }
                                    G += " " + this.toTP("ngx-icon-arrow-down")
                                } else {
                                    if (!this.rtl) {
                                        G += " " + this.toTP("ngx-grid-group-collapse");
                                        G += " " + this.toTP("ngx-icon-arrow-right")
                                    } else {
                                        G += " " + this.toTP("ngx-grid-group-collapse-rtl");
                                        G += " " + this.toTP("ngx-icon-arrow-left")
                                    }
                                }
                            }
                        } else {
                    ...
                    if (!this.autoRowHeight || (this.autoRowHeight && !ad.autoCellHeight)) {
                        G += " " + this.toTP("ngx-grid-cell-nowrap ")
                    }
                    ...
                    if (f != "") {
                        if (b.ngx.dataFormat) {
                            if (b.ngx.dataFormat.isDate(ai)) {
                                ai = b.ngx.dataFormat.formatdate(ai, f, aa.gridlocalization)
                            } else {
                                if (b.ngx.dataFormat.isNumber(ai) || (!isNaN(parseFloat(ai)) && isFinite(ai))) {
                                    ai = b.ngx.dataFormat.formatnumber(ai, f, aa.gridlocalization)
                                }
                            }
                        }
                    }
                ...
                if (this.rowDetails) {
                    ...
                    var G = this.toTP("ngx-cell") + " " + this.toTP("ngx-grid-cell") + " " + this.toTP("ngx-item");
                    G += " " + this.toTP("ngx-details");
                    G += " " + this.toTP("ngx-reset");
        ...
        setcolumnindex: function(e, i, j) {
            ...
            var k = this.toThemeProperty("ngx-grid-cell");
            k += " " + this.toThemeProperty("ngx-grid-cell-pinned");
            k += " " + this.toThemeProperty("ngx-item");
            var m = this;
            var c = null;
        ...
        _handlecolumnsReorder: function() {
            ...
            if (this.isTouchDevice() && this.touchmode !== true) {
                c = true;
                f = b.ngx.mobile.getTouchEventName("touchmove") + ".reorder" + this.element.id;
                e = b.ngx.mobile.getTouchEventName("touchstart") + ".reorder" + this.element.id;
                i = b.ngx.mobile.getTouchEventName("touchend") + ".reorder" + this.element.id
            }
            ...
            this.addHandler(b(document), f, function(k) {
                ...
                if (g.reordercolumn != null) {
                    ...
                    h = -1;
                    if (d) {
                        g.reordercolumnicon.removeClass(g.toThemeProperty("ngx-grid-dragcancel-icon"));
                        g.reordercolumnicon.addClass(g.toThemeProperty("ngx-grid-drag-icon"));
                        ...
                        g.reordercolumnicon.removeClass(g.toThemeProperty("ngx-grid-drag-icon"));
                        g.reordercolumnicon.addClass(g.toThemeProperty("ngx-grid-dragcancel-icon"))
                    }
                    if (k.preventDefault) {
                        k.preventDefault();
                        k.stopPropagation()
            ...
            this.addHandler(b(document), i, function(j) {
                ...
                g.__drag = false;
                b(document.body).removeClass("ngx-disableselect");
        ...
        _createreordercolumn: function(d, f, i) {
            ...
            k.css("opacity", "0.4");
            var j = b(k.find("." + h.toThemeProperty("ngx-grid-column-menubutton")));
            if (j.length > 0) {
                j.css("display", "none")
            }
            var c = b(k.find(".ngx-icon-close"));
            if (c.length > 0) {
                c.css("display", "none")
            }
            h.reordercolumnicon = b('<div style="z-index: 9999; position: absolute; left: 100%; top: 50%; margin-left: -18px; margin-top: -7px;"></div>');
            h.reordercolumnicon.addClass(h.toThemeProperty("ngx-grid-drag-icon"));
            ...
            if (i != undefined && i) {
                ...
                h.columnsdropline.addClass(h.toThemeProperty("ngx-grid-group-drag-line"));
        ...
        _handlecolumnsdragreorder: function(d, g) {
            ...
            if (c) {
                e = b.ngx.mobile.getTouchEventName("touchstart") + ".drag";
                f = b.ngx.mobile.getTouchEventName("touchmove") + ".drag"
            } else {
                ...
                if (h.dragmousedown) {
                    ...
                    if (!h.columndragstarted && h.reordercolumn == null) {
                        ...
                        if (l > 3 || n > 3) {
                            ...
                            b(document.body).addClass("ngx-disableselect");
        ...
        _handlecolumnsResize: function() {
            ...
            if (this.columnsResize) {
                ...
                if (k) {
                    var g = b.ngx.mobile.getTouchEventName("touchmove") + ".resize" + this.element.id;
                    var d = b.ngx.mobile.getTouchEventName("touchstart") + ".resize" + this.element.id;
                    var e = b.ngx.mobile.getTouchEventName("touchend") + ".resize" + this.element.id
                }
                ...
                this.addHandler(b(document), g, function(n) {
                    if (i.resizablecolumn != null && !i.disabled && i.resizing) {
                        if (i.resizeline != null) {
                            ...
                            var q = n.pageX;
                            if (k) {
                                var t = b.ngx.mobile.getTouches(n);
                                var r = t[0];
                                q = r.pageX
                            }
                            l += w;
                ...
                this.addHandler(b(document), d, function(m) {
                    if (i.resizablecolumn != null && !i.disabled) {
                        ...
                        b(document.body).addClass("ngx-disableselect");
                        b(document.body).addClass("ngx-position-reset");
                        ...
                        i.resizeline.addClass(i.toThemeProperty("ngx-grid-column-resizeline"));
                        i.resizestartline.addClass(i.toThemeProperty("ngx-grid-column-resizestartline"));
                ...
                var f = function() {
                    b(document.body).removeClass("ngx-disableselect");
                    b(document.body).removeClass("ngx-position-reset");
                    if (!i.resizing) {
                        return
                    }
        ...
        _updatecolumnwidths: function() {
            ...
            var d = 0;
            var g = f.find(".ngx-grid-column-header");
            var e = 0;
        ...
        _rendercolumnheaders: function() {
            ...
            b.each(this.columns.records, function(J, H) {
                ...
                var M = r.toTP("ngx-grid-column-header") + " " + r.toTP("ngx-widget-header");
                if (r.rtl) {
                    M += " " + r.toTP("ngx-grid-column-header-rtl")
                }
                if (!r.enableBrowserSelection) {
                    M += " " + r.toTP("ngx-disableselect")
                }
                ...
                if (z != null) {
                    var B = b('<div class="iconscontainer" style="height: ' + n + 'px; margin-left: -32px; display: block; position: absolute; left: 100%; top: 0%; width: 32px;"><div class="filtericon ' + r.toTP("ngx-widget-header") + '" style="height: ' + n + 'px; float: right; display: none; width: 16px;"><div class="' + r.toTP("ngx-grid-column-filterbutton") + '" style="width: 100%; height:100%;"></div></div><div class="sortasc ' + r.toTP("ngx-widget-header") + '" style="height: ' + n + 'px; float: right; display: none; width: 16px;"><div class="' + r.toTP("ngx-grid-column-sortascbutton") + '" style="width: 100%; height:100%;"></div></div><div class="sortdesc ' + r.toTP("ngx-widget-header") + '" style="height: ' + n + 'px; float: right; display: none; width: 16px;"><div class="' + r.toTP("ngx-grid-column-sortdescbutton") + '" style="width: 100%; height:100%;"></div></div></div>');
                    k.append(B);
                    var N = B.children();
                    this.sortasc = N[1];
                    this.sortdesc = N[2];
                ...
                if (r.columnsResize && !I) {
                    ...
                    if (r.isTouchDevice()) {
                        y = true;
                        j = b.ngx.mobile.getTouchEventName("touchstart")
                    }
                    r.addHandler(x, j, function(O) {
                        ...
                        if (r.hasTransform) {
                            T = b.ngx.utilities.getOffset(x).left
                        }
                        if (r._handlecolumnsResize) {
                            if (y) {
                                var P = b.ngx.mobile.getTouches(O);
                                var S = P[0];
                                i = S.pageX;
                                Q = 40;
                                if (i >= T + L.width - Q) {
        ...
        _rendercolumnGroups: function() {
            ...
            var n = this;
            var g = n.toTP("ngx-grid-column-header") + " " + n.toTP("ngx-grid-columngroup-header") + " " + n.toTP("ngx-widget-header");
            if (n.rtl) {
                g += " " + n.toTP("ngx-grid-columngroup-header-rtl")
            }
            var e = this.columnsheader.find("#columntable" + this.element.id);
            e.find("ngx-grid-columngroup-header").remove();
            ...
            if (e.aggregatesRenderer) {
                ...
                b.each(h, function() {
                    ...
                    for (g in j) {
                        ...
                        k.html(i + ":" + j[g]);
                        if (f.rtl) {
                            k.addClass(f.toThemeProperty("ngx-rtl"))
                        }
                        c.append(k)
                    }
                })
        ...
        _updateaggregates: function() {
            ...
            var l = this.toThemeProperty("ngx-grid-cell");
            if (this.rtl) {
                l += " " + this.toThemeProperty("ngx-grid-cell-rtl");
                f = 0;
                c.css("border-left-width", "0px");
                this.aggregates.css("border-left-color", "transparent")
            }
            l += " " + this.toThemeProperty("ngx-grid-cell-pinned");
            var n = m + 10;
            var o = new Array();
            ...
            for (var h = 0; h < m; h++) {
                ...
                var e = l;
                if (g.cellsalign) {
                    e += " " + this.toThemeProperty("ngx-" + g.cellsalign + "-align")
                }
            ...
            this.aggregates.removeClass(this.toThemeProperty("ngx-widget-header"));
            ...
            if (h.filterable) {
                if (h.filterrow) {
                    for (var f = 0; f < h.filterrow[0].cells.length; f++) {
                        ...
                        if (j.length > 0) {
                            j.ngxDropDownList("destroy")
                        }
                    }
                }
                if (h.filtercolumnsList) {
                    h.filtercolumnsList.ngxDropDownList("destroy")
                }
            }
            if (h.pageable) {
                if (h.pagershowrowscombotop && h.pagershowrowscombotop.ngxDropDownList) {
                    h.pagershowrowscombotop.ngxDropDownList("destroy")
                }
                if (h.pagershowrowscombobottom && h.pagershowrowscombobottom.ngxDropDownList) {
                    h.pagershowrowscombobottom.ngxDropDownList("destroy")
                }
                ...
                l.remove();
                if (h.pagernexttop) {
                    h.pagernexttop.ngxButton("destroy");
                    h.pagerprevioustop.ngxButton("destroy");
                    h.pagernextbottom.ngxButton("destroy");
                    h.pagerpreviousbottom.ngxButton("destroy");
                    h.pagerfirsttop.ngxButton("destroy");
                    h.pagerfirstbottom.ngxButton("destroy");
                    h.pagerlasttop.ngxButton("destroy");
                    h.pagerlastbottom.ngxButton("destroy")
                }
            }
            h._removeHandlers();
            h.vScrollBar.ngxScrollBar("destroy");
            h.hScrollBar.ngxScrollBar("destroy");
            delete h.vScrollBar;
            delete h.hScrollBar;
            delete h._mousewheelfunc;
            b.ngx.utilities.resize(h.host, null, true);
            h.host.remove()
        },
                                                ...
                                                if (l === "pagerPosition") {
                                                    ...
                                                    if (l === "selectionMode") {
                                                        ...
                                                        if (l == "touchmode") {
                                                            e._removeHandlers();
                                                            e.touchDevice = null;
                                                            e.vScrollBar.ngxScrollBar({
                                                                touchMode: k
                                                            });
                                                            e.hScrollBar.ngxScrollBar({
                                                                touchMode: k
                                                            });
                                                            e.refresh();
                                                            e._addHandlers()
                                                            ...
                                                            if (l == "enableHover") {
                                                                ...
                                                                if (l == "disabled") {
                                                                    if (k) {
                                                                        e.host.addClass(this.toThemeProperty("ngx-fill-state-disabled"))
                                                                    } else {
                                                                        e.host.removeClass(this.toThemeProperty("ngx-fill-state-disabled"))
                                                                    }
                                                                    if (e.pageable) {
                                                                        if (e.pagernexttop) {
                                                                            e.pagernexttop.ngxButton({
                                                                                disabled: k
                                                                            });
                                                                            e.pagerprevioustop.ngxButton({
                                                                                disabled: k
                                                                            });
                                                                            e.pagernextbottom.ngxButton({
                                                                                disabled: k
                                                                            });
                                                                            e.pagerpreviousbottom.ngxButton({
                                                                                disabled: k
                                                                            });
                                                                            e.pagerfirsttop.ngxButton({
                                                                                disabled: k
                                                                            });
                                                                            e.pagerfirstbottom.ngxButton({
                                                                                disabled: k
                                                                            });
                                                                            e.pagerlasttop.ngxButton({
                                                                                disabled: k
                                                                            });
                                                                            e.pagerlastbottom.ngxButton({
                                                                                disabled: k
                                                                            });
                                                                            if (e.pagershowrowscombotop.ngxDropDownList) {
                                                                                if (e.pagerMode == "advanced") {
                                                                                    e.pagershowrowscombotop.ngxDropDownList({
                                                                                        disabled: false
                                                                                    });
                                                                                    e.pagershowrowscombobottom.ngxDropDownList({
                                                                                        disabled: false
                                                                                    })
                                                                                }
                                                                            }
                                                                        }
                                                                        e.host.find(".ngx-grid-pager-number").css("cursor", k ? "default" : "pointer")
                                                                    }
                                                                    e.host.find(".ngx-grid-group-collapse").css("cursor", k ? "default" : "pointer");
                                                                    e.host.find(".ngx-grid-group-expand").css("cursor", k ? "default" : "pointer")
                                                                } else {
                                                                    if (l == "columnsHeight") {
                                                                        e._render()
                                                                    } else {
                                                                        if (l == "theme") {
                                                                            b.ngx.utilities.setTheme(d, k, e.host);
                                                                            e.vScrollBar.ngxScrollBar({
                                                                                theme: e.theme
                                                                            });
                                                                            e.hScrollBar.ngxScrollBar({
                                                                            ...
                                                                            if (e.filterable) {
                                                                                ...
                                                                                if (e.filtercolumnsList) {
                                                                                    e.filtercolumnsList.ngxDropDownList({
                                                                                        theme: e.theme
                                                                                    })
                                                                                }
                                                                            }
    ...
    function a(c, d) {
        ...
        this._initfields = function(f) {
            if (f != null) {
                var e = this;
                if (b.ngx.hasProperty(f, "dataField")) {
                    this.datafield = b.ngx.get(f, "dataField")
                }
                if (b.ngx.hasProperty(f, "displayField")) {
                    this.displayfield = b.ngx.get(f, "displayField")
                } else {
                    this.displayfield = this.datafield
                }
                if (b.ngx.hasProperty(f, "columnType")) {
                    this.columntype = b.ngx.get(f, "columnType")
                }
                if (b.ngx.hasProperty(f, "validation")) {
                    this.validation = b.ngx.get(f, "validation")
                }
                if (b.ngx.hasProperty(f, "autoCellHeight")) {
                    this.autoCellHeight = b.ngx.get(f, "autoCellHeight")
                }
                if (b.ngx.hasProperty(f, "text")) {
                    this.text = b.ngx.get(f, "text")
                } else {
                    this.text = this.displayfield
                }
                if (b.ngx.hasProperty(f, "sortable")) {
                    this.sortable = b.ngx.get(f, "sortable")
                }
                if (b.ngx.hasProperty(f, "hidden")) {
                    this.hidden = b.ngx.get(f, "hidden")
                }
                if (b.ngx.hasProperty(f, "groupable")) {
                    this.groupable = b.ngx.get(f, "groupable")
                }
                if (b.ngx.hasProperty(f, "renderer")) {
                    this.renderer = b.ngx.get(f, "renderer")
                }
                if (b.ngx.hasProperty(f, "align")) {
                    this.align = b.ngx.get(f, "align")
                }
                if (b.ngx.hasProperty(f, "cellsAlign")) {
                    this.cellsalign = b.ngx.get(f, "cellsAlign")
                }
                if (b.ngx.hasProperty(f, "cellsFormat")) {
                    this.cellsFormat = b.ngx.get(f, "cellsFormat")
                }
                if (b.ngx.hasProperty(f, "width")) {
                    this.width = b.ngx.get(f, "width")
                }
                if (b.ngx.hasProperty(f, "minWidth")) {
                    this.minwidth = b.ngx.get(f, "minWidth")
                }
                if (b.ngx.hasProperty(f, "maxWidth")) {
                    this.maxwidth = b.ngx.get(f, "maxWidth")
                }
                if (b.ngx.hasProperty(f, "cellsRenderer")) {
                    this.cellsRenderer = b.ngx.get(f, "cellsRenderer")
                }
                if (b.ngx.hasProperty(f, "columnType")) {
                    this.columntype = b.ngx.get(f, "columnType")
                }
                if (b.ngx.hasProperty(f, "pinned")) {
                    this.pinned = b.ngx.get(f, "pinned")
                }
                if (b.ngx.hasProperty(f, "filterable")) {
                    this.filterable = b.ngx.get(f, "filterable")
                }
                if (b.ngx.hasProperty(f, "filter")) {
                    this.filter = b.ngx.get(f, "filter")
                }
                if (b.ngx.hasProperty(f, "resizable")) {
                    this.resizable = b.ngx.get(f, "resizable")
                }
                if (b.ngx.hasProperty(f, "draggable")) {
                    this.draggable = b.ngx.get(f, "draggable")
                }
                if (b.ngx.hasProperty(f, "editable")) {
                    this.editable = b.ngx.get(f, "editable")
                }
                if (b.ngx.hasProperty(f, "initEditor")) {
                    this.initeditor = b.ngx.get(f, "initEditor")
                }
                if (b.ngx.hasProperty(f, "createEditor")) {
                    this.createeditor = b.ngx.get(f, "createEditor")
                }
                if (b.ngx.hasProperty(f, "destroyEditor")) {
                    this.destroyeditor = b.ngx.get(f, "destroyEditor")
                }
                if (b.ngx.hasProperty(f, "getEditorValue")) {
                    this.geteditorvalue = b.ngx.get(f, "getEditorValue")
                }
                if (b.ngx.hasProperty(f, "className")) {
                    this.classname = b.ngx.get(f, "className")
                }
                if (b.ngx.hasProperty(f, "cellClassName")) {
                    this.cellclassname = b.ngx.get(f, "cellClassName")
                }
                if (b.ngx.hasProperty(f, "aggregates")) {
                    this.aggregates = b.ngx.get(f, "aggregates")
                }
                if (b.ngx.hasProperty(f, "aggregatesRenderer")) {
                    this.aggregatesRenderer = b.ngx.get(f, "aggregatesRenderer")
                }
                if (b.ngx.hasProperty(f, "rendered")) {
                    this.rendered = b.ngx.get(f, "rendered")
                }
                if (b.ngx.hasProperty(f, "exportable")) {
                    this.exportable = b.ngx.get(f, "exportable")
                }
                if (b.ngx.hasProperty(f, "nullable")) {
                    this.nullable = b.ngx.get(f, "nullable")
                }
                if (b.ngx.hasProperty(f, "columnGroup")) {
                    this.columngroup = b.ngx.get(f, "columnGroup")
                }
                    ...
                    for (var g in f) {
                        if (!e.hasOwnProperty(g)) {
                            if (!e.hasOwnProperty(g.toLowerCase())) {
                                c.host.remove();
                                throw new Error("ngxGridView: Invalid property name - " + g + ".")
                            }
                        }
                    }
                }
    ...
    b.ngx.dataCollection = function(c) {
    ...
    b.ngx.dataView = function() {
        ...
        this.databind = function(p, k) {
            ...
            switch (p.datatype) {
                ...
                case "tab":
                    ...
                    var j = function() {
                        var v = b.ngx.browser.msie && b.ngx.browser.version < 9;
                        var w = function() {
                            r(f);
                            f.update()
                        };
        ...
        this._compare = function(d, c, f) {
            ...
            if (b.ngx.dataFormat) {
                if (f && f != "") {
                    ...
                    if (b.ngx.dataFormat.isNumber(d) && b.ngx.dataFormat.isNumber(c)) {
                        if (d < c) {
                            return -1
                        }
                        if (d > c) {
                        ...
                        if (b.ngx.dataFormat.isDate(d) && b.ngx.dataFormat.isDate(c)) {
                            if (d < c) {
                                return -1
                            }
                            if (d > c) {
        ...
        this.getid = function(j, d, e) {
                ...
                for (var f = 1; f <= 100; f++) {
                    ...
                    if (!g) {
                        if (this.grid && this.grid.treeGrid && this.grid.treeGrid.virtualModeCreateRecords) {
                            var g = this.grid.rowsByKey["ngx" + h + f];
                            if (g) {
                                continue
                            }
                            return "ngx" + h + f
            ...
            if (this.grid && this.grid.treeGrid && this.grid.treeGrid.virtualModeCreateRecords) {
                var g = this.grid.rowsByKey["ngx" + e];
                if (!g) {
                    return "ngx" + e
                } else {
                    for (var f = e + 1; f <= 100; f++) {
                        var g = this.grid.rowsByKey["ngx" + f];
                        if (!g) {
                            var g = this.grid.rowsByKey["ngx" + f];
                            if (g) {
                                continue
