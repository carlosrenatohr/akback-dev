...
*/
(function(a) {
    a.ngx.ngxWidget("ngxWindow", "", {});
    a.extend(a.ngx._ngxWindow.prototype, {
        defineInstance: function() {
            var e = {
                ...
                zIndex: 9001,
                _touchEvents: {
                    mousedown: a.ngx.mobile.getTouchEventName("touchstart"),
                    mouseup: a.ngx.mobile.getTouchEventName("touchend"),
                    mousemove: a.ngx.mobile.getTouchEventName("touchmove"),
                    mouseenter: "mouseenter",
                    mouseleave: "mouseleave",
                    click: a.ngx.mobile.getTouchEventName("touchstart")
                }
            };
        ...
        createInstance: function() {
            ...
            this._isTouchDevice = a.ngx.mobile.isTouchDevice();
            ...
            if (a.ngx.browser.msie) {
                this.host.addClass(this.toThemeProperty("ngx-noshadow"))
            }
            if (!this.isModal) {
        ...
        _fixWindowZIndex: function(m) {
            var e = a.data(document.body, "ngxwindows-list") || [],
                n = this.zIndex,
                h;
            if (!this.isModal) {
                ...
                a.data(document.body, "ngxwindows-list", e);
                if (e.length > 1) {
                    var f = e[e.length - 2];
                ...
                var g = a.data(document.body, "ngxwindows-modallist");
                if (!g) {
                    if (m == "modal-show") {
                        var k = new Array();
                        k.push(this.host);
                        a.data(document.body, "ngxwindows-modallist", k);
                        g = k
                    } else {
                        a.data(document.body, "ngxwindows-modallist", new Array());
                        g = new Array()
                    }
                } else {
                    if (m == "modal-show") {
                ...
                a.each(g, function(q) {
                    if (this.data()) {
                        if (this.data().ngxWindow) {
                            var o = this.data().ngxWindow.instance;
                ...
                a.data(document.body, "ngxwindow-modal", this.host);
                return
            }
        ...
        _singleModalCheck: function() {
            ...
            while (f) {
                ...
                if (a(e[f].attr("id")).length > 0) {
                    if (a(e[f].attr("id")).ngxWindow("isModal")) {
                        return false
                    }
                }
            }
        ...
        _addCloseButton: function() {
            if (!this._closeButton) {
                this._closeButtonWrapper = a('<div class="' + this.toThemeProperty("ngx-window-close-button-background") + '"></div>');
                this._closeButton = a('<div style="width: 100%; height: 100%;" class="' + this.toThemeProperty("ngx-window-close-button") + " " + this.toThemeProperty("ngx-icon-close") + '"></div>');
        ...
        _addCollapseButton: function() {
            if (!this._collapseButton) {
                this._collapseButtonWrapper = a('<div class="' + this.toThemeProperty("ngx-window-collapse-button-background") + '"></div>');
                this._collapseButton = a('<div style="width: 100%; height: 100%;" class="' + this.toThemeProperty("ngx-window-collapse-button") + " " + this.toThemeProperty("ngx-icon-arrow-up") + '"></div>');
        ...
        _removeModal: function() {
            if (!this.isModal && typeof this._modalBackground === "object" && this._modalBackground !== null && this._modalBackground.length >= 1) {
                a("." + this.toThemeProperty("ngx-window-modal")).remove();
        ...
        _makeModal: function() {
            if (this.isModal && (!this._modalBackground || this._modalBackground.length < 1)) {
                var g = a.data(document.body, "ngxwindows-list");
                if (g) {
                    this._removeFromArray(this.host, g);
                    a.data(document.body, "ngxwindows-list", g)
                }
                this._modalBackground = a("<div></div>");
                this._modalBackground.addClass(this.toThemeProperty("ngx-window-modal"));
                ...
                this.addHandler(a(document), "keydown.window" + this.element.id, function(l) {
                    ...
                    var h = a.data(document.body, "ngxwindows-modallist");
                    if (h.length > 1) {
        ...
        _addStyles: function() {
            this.host.addClass(this.toThemeProperty("ngx-rc-all"));
            this.host.addClass(this.toThemeProperty("ngx-window"));
            this.host.addClass(this.toThemeProperty("ngx-popup"));
            if (a.ngx.browser.msie) {
                this.host.addClass(this.toThemeProperty("ngx-noshadow"))
            }
            this.host.addClass(this.toThemeProperty("ngx-widget"));
            this.host.addClass(this.toThemeProperty("ngx-widget-content"));
            this._header.addClass(this.toThemeProperty("ngx-window-header"));
            this._content.addClass(this.toThemeProperty("ngx-window-content"));
            this._header.addClass(this.toThemeProperty("ngx-widget-header"));
            this._content.addClass(this.toThemeProperty("ngx-widget-content"));
            this._header.addClass(this.toThemeProperty("ngx-disableselect"));
            this._header.addClass(this.toThemeProperty("ngx-rc-t"));
            this._content.addClass(this.toThemeProperty("ngx-rc-b"));
        ...
        _addHeaderHoverEffect: function() {
            ...
            this.addHandler(this._header, this._getEvent("mouseenter"), function() {
                a(this).addClass(e.toThemeProperty("ngx-window-header-hover"))
            });
            this.addHandler(this._header, this._getEvent("mouseleave"), function() {
                a(this).removeClass(e.toThemeProperty("ngx-window-header-hover"))
            })
        },
        ...
        _getDocumentSize: function() {
            var e = a.ngx.browser.msie && a.ngx.browser.version < 9;
            var f = e ? 4 : 0;
            var g = f;
        ...
        _closeButtonHover: function() {
            ...
            this.addHandler(this._closeButton, this._getEvent("mouseenter"), function() {
                e._closeButton.addClass(e.toThemeProperty("ngx-window-close-button-hover"))
            });
            this.addHandler(this._closeButton, this._getEvent("mouseleave"), function() {
                e._closeButton.removeClass(e.toThemeProperty("ngx-window-close-button-hover"))
            })
        },
        _collapseButtonHover: function() {
            var e = this;
            this.addHandler(this._collapseButton, this._getEvent("mouseenter"), function() {
                e._collapseButton.addClass(e.toThemeProperty("ngx-window-collapse-button-hover"))
            });
            this.addHandler(this._collapseButton, this._getEvent("mouseleave"), function() {
                e._collapseButton.removeClass(e.toThemeProperty("ngx-window-collapse-button-hover"))
            })
        },
        ...
        _headerMouseDownHandler: function(f, g) {
            ...
            if (f._resizeDirection == null) {
                var h = a.ngx.mobile.getTouches(g);
                var i = h[0];
                var e = a.ngx.position(g);
        ...
        _headerMouseMoveHandler: function(f, i) {
            if (f._mouseDown && !f._isDragging) {
                var k = a.ngx.mobile.getTouches(i);
                var l = k[0];
                var h = l.pageX,
                    g = l.pageY;
                var e = a.ngx.position(i);
                h = e.left;
                g = e.top;
                if ((h + 3 < f._mousePosition.x || h - 3 > f._mousePosition.x) || (g + 3 < f._mousePosition.y || g - 3 > f._mousePosition.y)) {
                    ...
                    a(document.body).addClass(f.toThemeProperty("ngx-disableselect"))
                }
                if (f._isTouchDevice) {
                    i.preventDefault();
                    return true
        ...
        _dropHandler: function(g, k) {
            ...
            g._isDragging = false;
            g._mouseDown = false;
            a(document.body).removeClass(g.toThemeProperty("ngx-disableselect"));
            return f
        },
        _dragHandler: function(p, h) {
            if (p._isDragging && !p.isResizing && !p._resizeDirection) {
                ...
                if (o === 0 && a.ngx.browser.msie && a.ngx.browser.version < 8) {
                    return p._dropHandler(p, h)
                }
                var m = a.ngx.mobile.getTouches(h);
                var l = m[0];
                var n = a.ngx.position(h);
                var k = n.left,
                    i = n.top,
        ...
        propertyChangedHandler: function(e, f, h, g) {
            ...
            switch (f) {
                ...
                case "theme":
                    a.ngx.utilities.setTheme(h, g, this.host);
                    break;
                case "enableResize":
                    return;
                case "maxWidth":
        ...
        collapse: function(g) {
            if (!this.collapsed && !this.host.is(":animated")) {
                ...
                this.host.animate({
                    ...
                    e.collapsed = true;
                    e._collapseButton.addClass(e.toThemeProperty("ngx-window-collapse-button-collapsed"));
                    e._collapseButton.addClass(e.toThemeProperty("ngx-icon-arrow-down"));
                    e._content.css("display", "none");
                    e._raiseEvent(5);
                    e._raiseEvent(9);
                    a.ngx.aria(e, "aria-expanded", false)
                })
            }
        },
        expand: function(f) {
            if (this.collapsed && !this.host.is(":animated")) {
                ...
                this.host.animate({
                    ...
                    e._collapseButton.removeClass(e.toThemeProperty("ngx-window-collapse-button-collapsed"));
                    e._collapseButton.removeClass(e.toThemeProperty("ngx-icon-arrow-down"));
                    e._content.css("display", "block");
                    e._raiseEvent(6);
                    e._performWidgetLayout();
                    e._raiseEvent(9);
                    a.ngx.aria(e, "aria-expanded", true)
                })
            }
        },
        closeAll: function(h) {
            ...
            var g = a.data(document.body, "ngxwindows-list"),
                f = g.length,
                e = a.data(document.body, "ngxwindow-modal") || [];
            while (f) {
                f -= 1;
                if (this._toClose(h, g[f])) {
                    g[f].ngxWindow("closeWindow", "close");
                    g.splice(f, 1)
                }
            }
            if (this._toClose(h, e)) {
                e.ngxWindow("closeWindow", "close");
                a.data(document.body, "ngxwindow-modal", [])
            }
            a.data(document.body, "ngxwindows-list", g)
        },
        setTitle: function(e) {
            a.ngx.utilities.html(this._headerContentWrapper, e);
            this.title = e;
            this._performLayout()
        },
        setContent: function(f) {
            ...
            a.ngx.utilities.html(this._content, f);
            this._performLayout()
        },
        disable: function() {
            this.disabled = true;
            this._removeEventHandlers();
            this._header.addClass(this.toThemeProperty("ngx-window-header-disabled"));
            this._closeButton.addClass(this.toThemeProperty("ngx-window-close-button-disabled"));
            this._collapseButton.addClass(this.toThemeProperty("ngx-window-collapse-button-disabled"));
            this._content.addClass(this.toThemeProperty("ngx-window-content-disabled"));
            this.host.addClass(this.toThemeProperty("ngx-window-disabled"));
        ...
        enable: function() {
            if (this.disabled) {
                this._addEventHandlers();
                this._header.removeClass(this.toThemeProperty("ngx-window-header-disabled"));
                this._content.removeClass(this.toThemeProperty("ngx-window-content-disabled"));
                this._closeButton.removeClass(this.toThemeProperty("ngx-window-close-button-disabled"));
                this._collapseButton.removeClass(this.toThemeProperty("ngx-window-collapse-button-disabled"));
                this.host.removeClass(this.toThemeProperty("ngx-window-disabled"));
                this.host.removeClass(this.toThemeProperty("ngx-fill-state-disabled"));
                this.disabled = false;
                this._initializeResize()
            }
        },
        ...
        bringToFront: function() {
            var f = a.data(document.body, "ngxwindows-list");
            if (this.isModal) {
                f = a.data(document.body, "ngxwindows-modallist");
        ...
        move: function(q, p, e, h) {
            ...
            if (parseInt(this.host.css("left"), 10) !== n.x || parseInt(this.host.css("top"), 10) !== n.y) {
                if (e) {
                    var m = a.ngx.mobile.getTouches(e);
                    var l = m[0];
                    var o = a.ngx.position(e);
                    k = o.left;
                    i = o.top
                }
                if (k == undefined) {
...
(function(b) {
        ...
        return {
            ...
            removeResize: function() {
                if (this.resizeTarget) {
                    var f = c(this.resizeTarget.children(".ngx-resize"));
                    f.detach();
                    var e = f.children();
            ...
            _renderResize: function() {
                ...
                this._resizeWrapper.addClass("ngx-resize");
                this._resizeWrapper.addClass("ngx-rc-all");
            ...
            _stopResizing: function(d, e) {
                if (d.enableResize) {
                    ...
                    if (d.resizeTarget) {
                        d.resizeTarget.removeClass("ngx-disableselect")
                    }
                }
            ...
            _resizeHandler: function(d, e) {
                if (d.enableResize && !d.collapsed) {
                    if (d.isResizing && d._resizeDirection) {
                        if (e.which === 0 && c.ngx.browser.msie && c.ngx.browser.version < 9) {
                            d._stopResizing(e)
                        }
            ...
            _resizeCaptureCursor: function(e, d) {
                if (this._resizeMouseDown && !this.isResizing && this._resizeDirection) {
                    if ((e + 3 < this._mouseResizePosition.x || e - 3 > this._mouseResizePosition.x) || (d + 3 < this._mouseResizePosition.y || d - 3 > this._mouseResizePosition.y)) {
                        ...
                        this.resizeTarget.addClass("ngx-disableselect");
                        return false
                    }
                }
            },
            ...
            _validateHeight: function(f, k, i) {
                var l = 0,
                    ...
                    h = f,
                    g = this._getParent();
                if (c(window).width() > c(document).width() && c.ngx.browser.msie && g.height === c(document).height()) {
            ...
            _validateWidth: function(k, i, h) {
                var l = 0,
                    ...
                    g = k,
                    f = this._getParent();
                if (c(window).height() < c(document).height() && c.ngx.browser.msie && document.documentElement.clientWidth >= document.documentElement.scrollWidth && f.width === c(document).width()) {
                    l = this._SCROLL_WIDTH
                }
    ...
    b.extend(b.ngx._ngxWindow.prototype, a)
}(ngxBaseFramework));