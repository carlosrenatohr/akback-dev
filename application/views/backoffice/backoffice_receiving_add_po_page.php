<?php
    jqxangularjs();
    jqxthemes();
    $array = $this->uri->segment_array(5);
?>
...
<div class="row-offcanvas row-offcanvas-left ng-cloak">
    <div class="container-fluid" onkeydown="KeyPress(event)">
    	<div class="row alert-danger">
        	<span style="color:#000; font-weight:bold;"><?php echo "ID: ". $array[5]?></span>
        </div>
        <div class="row">
            <div id="receiving-addnew-form">
                <div class="container-fluid">
                    ...
                    <div class="col-md-12" ng-show="AskBox">
                        ...
                        <div class="row" style="margin-top:10px;">
                            <button ng-click="AskNo()" class="btn btn-success btn-lg">Yes</button> <!--/Delete no/-->
                            <button ng-click="AskYes()" class="btn btn-primary btn-lg">No</button> <!--/Delete yes/-->
