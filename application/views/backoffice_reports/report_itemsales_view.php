...
<script type="text/javascript">
	...
	*/
	...
	function get_details(){
		...
		$.ajax({
			url: window.location.origin + '/akback/backoffice/reports/itemsales_select',
			type: 'POST',
			data: postdata,
			beforeSend: function(){
		 ...
		 //var url = window.location.origin + '/akback/backoffice/reports/payments_select/'+date_from+'/'+date_to;
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
					...
					{ text: 'List Price', dataField: 'ListPrice', width: '7%',align: 'right',cellsalign: 'right'},
					{ text: 'Discount', dataField: 'Discount', cellsformat: 'd2',width: '7%',align: 'right',cellsalign: 'right'},
                    { text: 'Sell Price', dataField: 'SellPrice', cellsformat: 'd2',width: '6%',align: 'right',cellsalign: 'right'},
					...
					{ text: 'Ext Sell', dataField: 'ExtSellPrice', cellsformat: 'd2',width: '10%',align: 'right',cellsalign: 'right',
						aggregates: ['sum'], aggregatesrenderer: function (aggregates, column, element, summaryData) {
                          var renderstring = "<div class='jqx-widget-content jqx-widget-content-" + theme + "' style='float: left; width: 100%; height: 100%;'>";
                          $.each(aggregates, function (key, value) {
                              var name = key == 'sum' ? 'Sum' : 'Avg';
					 ...
					 { text: 'Total', dataField: 'Total', cellsformat: 'd2',width: '5%',align: 'right',cellsalign: 'right',
						aggregates: ['sum'], aggregatesrenderer: function (aggregates, column, element, summaryData) {
                          var renderstring = "<div class='jqx-widget-content jqx-widget-content-" + theme + "' style='float: left; width: 100%; height: 100%;'>";
                          $.each(aggregates, function (key, value) {
                              var name = key == 'sum' ? 'Sum' : 'Avg';
