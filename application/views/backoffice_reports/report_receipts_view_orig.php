...
<script type="text/javascript">
	...
	$("#status").on('checkChange', function (event) {
	...
	*/
	function get_salesdetails(){
		...
		$.ajax({
			url: 'http://localhost/akback/backoffice/reports/receipts_select_ajax',
			type: 'POST',
			data: postdata,
			beforeSend: function(){
				$('body').block({message: 'Loading...'})
     ...
     alert("Binding is completed" );			
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
					...
					{ text: 'SubTotal', dataField: 'SubTotal', cellsformat: 'd2',width: '10%',filtertype: 'input',align: 'right',cellsalign: 'right',
					 ...
					 { text: 'Tax', dataField: 'Tax', cellsformat: 'd2',width: '10%',filtertype: 'input',align: 'right',cellsalign: 'right',
						aggregates: ['sum'], aggregatesrenderer: function (aggregates, column, element, summaryData) {
                          var renderstring = "<div class='jqx-widget-content jqx-widget-content-" + theme + "' style='float: left; width: 100%; height: 100%;'>";
                          $.each(aggregates, function (key, value) {
                              var name = key == 'sum' ? 'Sum' : 'Avg';
					 ...
					 { text: 'Total', dataField: 'Total', cellsformat: 'd2',width: '10%',filtertype: 'input',align: 'right',cellsalign: 'right',
						aggregates: ['sum'], aggregatesrenderer: function (aggregates, column, element, summaryData) {
                          var renderstring = "<div class='jqx-widget-content jqx-widget-content-" + theme + "' style='float: left; width: 100%; height: 100%;'>";
                          $.each(aggregates, function (key, value) {
                              var name = key == 'sum' ? 'Sum' : 'Avg';
					 ...
					 { text: 'Paid', dataField: 'Paid', filtertype: 'input',cellsformat: 'd2',width: '10%',align: 'right',cellsalign: 'right',
						aggregates: ['sum'], aggregatesrenderer: function (aggregates, column, element, summaryData) {
                          var renderstring = "<div class='jqx-widget-content jqx-widget-content-" + theme + "' style='float: left; width: 100%; height: 100%;'>";
                          $.each(aggregates, function (key, value) {
                              var name = key == 'sum' ? 'Sum' : 'Avg';
					 ...
					 { text: 'Balance', dataField: 'Balance', cellsformat: 'd2',width: '10%',filtertype: 'input',align: 'right',cellsalign: 'right',
						aggregates: ['sum'], aggregatesrenderer: function (aggregates, column, element, summaryData) {
                          var renderstring = "<div class='jqx-widget-content jqx-widget-content-" + theme + "' style='float: left; width: 100%; height: 100%;'>";
                          $.each(aggregates, function (key, value) {
                              var name = key == 'sum' ? 'Sum' : 'Avg';
