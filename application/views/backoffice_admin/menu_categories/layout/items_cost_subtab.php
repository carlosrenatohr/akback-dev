        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <div class="input-group">
                    ...
                    <jqx-number-input id="item_cost" class="menuitem_pricesControls"
    ...
    <div class="row">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <div class="input-group">
                    <span class="input-group-addon">$</span>
                    <jqx-number-input id="item_Cost_Extra" class="menuitem_pricesControls"
                                      jqx-width="120" jqx-height="30"
    ...
    <div class="row">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <div class="input-group">
                    <span class="input-group-addon">$</span>
                    <jqx-number-input id="item_Cost_Freight" class="menuitem_pricesControls"
                                      jqx-width="120" jqx-height="30"
                                      jqx-spin-buttons="false" jqx-input-mode="simple"
    ...
    <div class="row">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <div class="input-group">
                    <span class="input-group-addon">$</span>
                    <jqx-number-input id="item_Cost_Duty" class="menuitem_pricesControls"
                                      jqx-width="120" jqx-height="30"
                                      jqx-spin-buttons="false" jqx-input-mode="simple"
                                      jqx-symbol="''" ng-change="onChangeCostFieldsMenuItem()"
                                      jqx-decimal-digits="<?= $decimalsPrice; ?>"
    ...
    <div class="row">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <div class="input-group">
                    <span class="input-group-addon">$</span>
                    <jqx-number-input id="item_Cost_Landed" class="menuitem_pricesControls"
                                      jqx-width="120" jqx-height="30"
                                      jqx-spin-buttons="false" jqx-input-mode="simple"
                                      jqx-symbol="''" ng-change="onChangeCostFieldsMenuItem()"
                                      jqx-decimal-digits="<?= $decimalsPrice; ?>"
