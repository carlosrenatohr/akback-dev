        ...
        <div style=" width:100%;float:left;margin: 15px 0;">
            ...
            <div style="float:left; padding:2px; width:650px; ">
                ...
                <div style=" float:left; width:300px;">
                    <jqx-number-input
                        style='margin-top: 3px;' class="menuitem_pricesControls"
                        id="menuitem_price2" name="menuitem_price2"
            ...
            <div style="float:left; padding:2px; width:650px; ">
                ...
                <div style=" float:left; width:300px;">
                    <jqx-number-input
                        style='margin-top: 3px;' class="menuitem_pricesControls"
                        id="menuitem_price3" name="menuitem_price3"
                        jqx-settings="numberPricesSet"
                    ></jqx-number-input>
                </div>
            </div>
            <div style="float:left; padding:2px; width:650px; ">
                ...
                <div style=" float:left; width:300px;">
                    <jqx-number-input
                        style='margin-top: 3px;' class="menuitem_pricesControls"
                        id="menuitem_price4" name="menuitem_price4"
                        jqx-settings="numberPricesSet"
                    ></jqx-number-input>
                </div>
            </div>
            <div style="float:left; padding:2px; width:650px; ">
                ...
                <div style=" float:left; width:300px;">
                    <jqx-number-input
                        style='margin-top: 3px;' class="menuitem_pricesControls"
                        id="menuitem_price5" name="menuitem_price5"
                        jqx-settings="numberPricesSet"
                    ></jqx-number-input>
                </div>
            </div>
